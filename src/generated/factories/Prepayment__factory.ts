...
import type { Prepayment, PrepaymentInterface } from "../Prepayment";
...
export class Prepayment__factory {
  static readonly abi = _abi;
  static createInterface(): PrepaymentInterface {
    return new utils.Interface(_abi) as PrepaymentInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Prepayment {
    return new Contract(address, _abi, signerOrProvider) as Prepayment;
  }
}
