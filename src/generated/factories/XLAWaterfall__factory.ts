...
import type { XLAWaterfall, XLAWaterfallInterface } from "../XLAWaterfall";
...
export class XLAWaterfall__factory {
  static readonly abi = _abi;
  static createInterface(): XLAWaterfallInterface {
    return new utils.Interface(_abi) as XLAWaterfallInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XLAWaterfall {
    return new Contract(address, _abi, signerOrProvider) as XLAWaterfall;
  }
}
