...
import type {
  XLAValveFactory,
  XLAValveFactoryInterface,
} from "../XLAValveFactory";
...
export class XLAValveFactory__factory {
  static readonly abi = _abi;
  static createInterface(): XLAValveFactoryInterface {
    return new utils.Interface(_abi) as XLAValveFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XLAValveFactory {
    return new Contract(address, _abi, signerOrProvider) as XLAValveFactory;
  }
}
