...
export interface XLAPrepaymentUSDInterface extends utils.Interface {
  functions: {
    ...
    "initialize((address,address,address,bool,bool,uint256,uint256,address,address[],address[]),address,uint256,uint256,uint256,address,address[],uint256[],string[])": FunctionFragment;
...
export interface XLAPrepaymentUSD extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XLAPrepaymentUSDInterface;
