...
export interface XLAValveInterface extends utils.Interface {
  functions: {
    ...
    "initialize(address,address,address,bool,bool,uint256,uint256,address,address[],uint256[],string[])": FunctionFragment;
...
export interface XLAValve extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XLAValveInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      _autoEthDistribution: PromiseOrValue<boolean>,
