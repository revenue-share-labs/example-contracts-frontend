...
export interface XLAWaterfallUsdInterface extends utils.Interface {
  functions: {
    ...
    "initialize((address,address,address,bool,bool,uint256,uint256,address,address[],address[]),address[],uint256[],uint256[],string[],address)": FunctionFragment;
    ...
    "setEthPriceFeed(address)": FunctionFragment;
    "setRecipients(address[],uint256[],uint256[],string[])": FunctionFragment;
    "setTokenUsdPriceFeed(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setTokenUsdPriceFeed",
  ...
  events: {
    ...
    "CurrentRecipientFulfilled(address)": EventFragment;
    "DistributeToken(address,uint256)": EventFragment;
    "DistributorChanged(address,address)": EventFragment;
    "EthPriceFeedSet(address,address)": EventFragment;
    "Initialized(uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "SetRecipients(address[],uint256[],uint256[],string[])": EventFragment;
    "TokenPriceFeedSet(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "ControllerChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "CurrentRecipientFulfilled"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "EthPriceFeedSet"): EventFragment;
...
export interface CurrentRecipientFulfilledEventObject {
  recipient: string;
}
export type CurrentRecipientFulfilledEvent = TypedEvent<
  [string],
  CurrentRecipientFulfilledEventObject
>;

export type CurrentRecipientFulfilledEventFilter =
  TypedEventFilter<CurrentRecipientFulfilledEvent>;
...
export interface EthPriceFeedSetEventObject {
  oldEthPriceFeed: string;
  newEthPriceFeed: string;
}
export type EthPriceFeedSetEvent = TypedEvent<
  [string, string],
  EthPriceFeedSetEventObject
>;

export type EthPriceFeedSetEventFilter = TypedEventFilter<EthPriceFeedSetEvent>;
...
export interface XLAWaterfallUsd extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XLAWaterfallUsdInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      _ethUsdPriceFeed: PromiseOrValue<string>,
  ...
  filters: {
    ...
    "CurrentRecipientFulfilled(address)"(
      recipient?: null
    ): CurrentRecipientFulfilledEventFilter;
    CurrentRecipientFulfilled(
      recipient?: null
    ): CurrentRecipientFulfilledEventFilter;
    ...
    "EthPriceFeedSet(address,address)"(
      oldEthPriceFeed?: null,
      newEthPriceFeed?: null
    ): EthPriceFeedSetEventFilter;
    EthPriceFeedSet(
      oldEthPriceFeed?: null,
      newEthPriceFeed?: null
    ): EthPriceFeedSetEventFilter;
    ...
    "SetRecipients(address[],uint256[],uint256[],string[])"(
      recipients?: null,
      maxCaps?: null,
      priorities?: null,
      names?: null
