...
export interface XLAValveFactoryInterface extends utils.Interface {
  functions: {
    "contractImplementation()": FunctionFragment;
    "createRSCValve((string,address,address,bool,bool,uint256,address[],uint256[],string[]))": FunctionFragment;
  ...
  events: {
    ...
    "RSCValveCreated(address,address,address,string,uint256,bool,bool,uint256)": EventFragment;
  };
...
export interface XLAValveFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XLAValveFactoryInterface;
  ...
  filters: {
    ...
    "RSCValveCreated(address,address,address,string,uint256,bool,bool,uint256)"(
